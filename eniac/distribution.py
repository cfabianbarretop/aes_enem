...
# ==============================================
class Graphs():
    def __init__(self, root: str, digit_dist: str, sum_dist: str, digit_comb: str, train_loader, test_loader):
...
def main_distribution(train_loader, test_loader):
  ...
  graph = Graphs(result_dir, digit_dist, sum_dist, digit_comb, train_loader, test_loader)
