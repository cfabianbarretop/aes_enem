...
class Graphs():
    ...
    def show_img(self):
        samples = {}
        for (img1, img2, img3), _, (digit1, digit2, digit3), _ in self.train_loader:
    ...
    def digit_distribution(self):
        ...
        # Train
        for _, _, (digit1, digit2, digit3), _ in self.train_loader:
            train_counts.update(digit1.tolist())
            train_counts.update(digit2.tolist())
            train_counts.update(digit3.tolist())

        # Test
        for _, _, (digit1, digit2, digit3), _ in self.test_loader:
    ...
    def label_distribution(self):
        ...
        for _, _, _, (_, label) in self.train_loader:
            train_sum_counts.update(label.tolist())

        for _, _, _, (_, label) in self.test_loader:
    ...
    def show_valid_outfits(self, n_samples=3, valid = True):
        ...
        for (img1, img2, img3), _, (digit1, digit2, digit3), (_, label) in self.train_loader:
